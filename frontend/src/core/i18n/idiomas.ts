...
const es: Diccionario = {
  ...
  'nav.facturas': 'Todas las facturas',
  'nav.auditoriaFinanciera': 'Auditoría financiera',
  'nav.antiguedad': 'Antigüedad de cuentas',
  'nav.planPagos': 'Planificador de pagos',
  'nav.flujoCaja': 'Flujo de caja',
  'nav.gastos': 'Gastos',
...
const en: Diccionario = {
  ...
  'nav.facturas': 'All invoices',
  'nav.auditoriaFinanciera': 'Financial audit',
  'nav.antiguedad': 'Payables aging',
  'nav.planPagos': 'Payment planner',
  'nav.flujoCaja': 'Cash flow',
  'nav.gastos': 'Expenses',
  'nav.dashboard': 'Dashboard',
  'nav.sedes': 'Locations',
