/**
 * Utilidades de presentación para el módulo de gastos.
 */
 ...
 * Se usa como valor por defecto en los filtros de período.
 */
 ...
 * Se usa como valor por defecto del campo "desde" en filtros.
 */
